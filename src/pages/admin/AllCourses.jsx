...
const AllCourses = () => {
  ...
  const [confirmDeleteOpenModal, setConfirmDeleteOpenModal] = useState(true);
...
// show course Detail
  ...
  return (
    <div>
        ...
        <div className='p-4'>
          Courses : {courseData?.totalElements}
        </div>
      ...
      <Table hoverable>
        ...
        <Table.Body className="divide-y">
          ...
          {courseData.content.map((course, index) => (
              ...
              <a href="#" className="ml-3 font-medium text-cyan-600 hover:underline dark:text-cyan-500"
              onClick={() => {
              ...
              <a href="#" onClick={() => {
                ...
                Delete
                {/* {console.log(confirmDeleteOpenModal)} */}
         ...
         <div className='text-center'>
          ...
          >
            ...
            <div className='flex flex-col justify-center items-center'>
                <img src={courseToDisplay?.bannerUrl} alt=''
